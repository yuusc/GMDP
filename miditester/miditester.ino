...
void loop() {
  ...
  delay(100);
  SEND_MIDI(MIDI_OFF_CH1, 48, 0);
  SEND_MIDI(MIDI_ON_CH1, 50, VELOCITY);
  delay(100);
  SEND_MIDI(MIDI_OFF_CH1, 50, 0);
  SEND_MIDI(MIDI_ON_CH1, 52, VELOCITY);
  delay(100);
  SEND_MIDI(MIDI_OFF_CH1, 52, 0);
  SEND_MIDI(MIDI_ON_CH1, 53, VELOCITY);
  delay(100);
  SEND_MIDI(MIDI_OFF_CH1, 53, 0);
  SEND_MIDI(MIDI_ON_CH1, 55, VELOCITY);
  delay(100);
  SEND_MIDI(MIDI_OFF_CH1, 55, 0);
  SEND_MIDI(MIDI_ON_CH1, 57, VELOCITY);
  delay(100);
  SEND_MIDI(MIDI_OFF_CH1, 57, 0);
  SEND_MIDI(MIDI_ON_CH1, 59, VELOCITY);
  delay(100);
  SEND_MIDI(MIDI_OFF_CH1, 59, 0);
  SEND_MIDI(MIDI_ON_CH1, 60, VELOCITY);
  delay(100);
  SEND_MIDI(MIDI_OFF_CH1, 60, 0);
  ...
  delay(100);
  SEND_MIDI(MIDI_OFF_CH1, 60, 0);
  SEND_MIDI(MIDI_ON_CH1, 62, VELOCITY);
  delay(100);
  SEND_MIDI(MIDI_OFF_CH1, 62, 0);
  SEND_MIDI(MIDI_ON_CH1, 64, VELOCITY);
  delay(100);
  SEND_MIDI(MIDI_OFF_CH1, 64, 0);
  SEND_MIDI(MIDI_ON_CH1, 65, VELOCITY);
  delay(100);
  SEND_MIDI(MIDI_OFF_CH1, 65, 0);
  SEND_MIDI(MIDI_ON_CH1, 67, VELOCITY);
  delay(100);
  SEND_MIDI(MIDI_OFF_CH1, 67, 0);
  SEND_MIDI(MIDI_ON_CH1, 69, VELOCITY);
  delay(100);
  SEND_MIDI(MIDI_OFF_CH1, 69, 0);
  SEND_MIDI(MIDI_ON_CH1, 71, VELOCITY);
  delay(100);
  SEND_MIDI(MIDI_OFF_CH1, 71, 0);
  SEND_MIDI(MIDI_ON_CH1, 72, VELOCITY);
  delay(100);
  SEND_MIDI(MIDI_OFF_CH1, 72, 0);
  ...
  delay(100);
  SEND_MIDI(MIDI_OFF_CH1, 72, 0);
  SEND_MIDI(MIDI_ON_CH1, 74, VELOCITY);
  delay(100);
  SEND_MIDI(MIDI_OFF_CH1, 74, 0);
  SEND_MIDI(MIDI_ON_CH1, 76, VELOCITY);
  delay(100);
  SEND_MIDI(MIDI_OFF_CH1, 76, 0);
  SEND_MIDI(MIDI_ON_CH1, 77, VELOCITY);
  delay(100);
  SEND_MIDI(MIDI_OFF_CH1, 77, 0);
  SEND_MIDI(MIDI_ON_CH1, 79, VELOCITY);
  delay(100);
  SEND_MIDI(MIDI_OFF_CH1, 79, 0);
  SEND_MIDI(MIDI_ON_CH1, 81, VELOCITY);
  delay(100);
  SEND_MIDI(MIDI_OFF_CH1, 81, 0);
  SEND_MIDI(MIDI_ON_CH1, 83, VELOCITY);
  delay(100);
  SEND_MIDI(MIDI_OFF_CH1, 83, 0);
  SEND_MIDI(MIDI_ON_CH1, 84, VELOCITY);
  delay(100);
  SEND_MIDI(MIDI_OFF_CH1, 84, 0);
